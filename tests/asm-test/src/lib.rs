    ...
    macro_rules! t {
        ($t:ident) => {
            pub mod $t {
                ...
                #[inline(never)]
                pub unsafe fn acquire(src: A) -> M {
                    <T as crate::AtomicLoad>::atomic_load(src, Ordering::Acquire)
                }
                #[inline(never)]
                pub unsafe fn seqcst(src: A) -> M {
                    <T as crate::AtomicLoad>::atomic_load(src, Ordering::SeqCst)
                }
            }
        };
    }
        ...
        ($t:ident) => {
            pub mod $t {
                ...
                pub unsafe fn relaxed(dst: A, val: M) {
                    <T as crate::AtomicStore>::atomic_store(dst, val, Ordering::Relaxed)
                }
                #[inline(never)]
                pub unsafe fn release(dst: A, val: M) {
                    <T as crate::AtomicStore>::atomic_store(dst, val, Ordering::Release)
                }
                #[inline(never)]
                pub unsafe fn seqcst(dst: A, val: M) {
                    <T as crate::AtomicStore>::atomic_store(dst, val, Ordering::SeqCst)
                }
            }
        };
    }
        ...
        ($t:ident) => {
            pub mod $t {
                ...
                pub unsafe fn relaxed(dst: A, val: M) -> M {
                    <T as crate::AtomicSwap>::atomic_swap(dst, val, Ordering::Relaxed)
                }
                #[inline(never)]
                pub unsafe fn acquire(dst: A, val: M) -> M {
                    <T as crate::AtomicSwap>::atomic_swap(dst, val, Ordering::Acquire)
                }
                #[inline(never)]
                pub unsafe fn release(dst: A, val: M) -> M {
                    <T as crate::AtomicSwap>::atomic_swap(dst, val, Ordering::Release)
                }
                #[inline(never)]
                pub unsafe fn acqrel(dst: A, val: M) -> M {
                    <T as crate::AtomicSwap>::atomic_swap(dst, val, Ordering::AcqRel)
                }
                #[inline(never)]
                pub unsafe fn seqcst(dst: A, val: M) -> M {
                    <T as crate::AtomicSwap>::atomic_swap(dst, val, Ordering::SeqCst)
                }
            }
        };
    }
        ...
        ($t:ident) => {
            pub mod $t {
                ...
                pub unsafe fn relaxed_relaxed(dst: A, old: M, new: M) -> (M, bool) {
                    <T as crate::AtomicCompareExchange>::atomic_compare_exchange(
                        dst,
                        old,
                        new,
                        Ordering::Relaxed,
                ...
                #[inline(never)]
                pub unsafe fn relaxed_acquire(dst: A, old: M, new: M) -> (M, bool) {
                    <T as crate::AtomicCompareExchange>::atomic_compare_exchange(
                        dst,
                        old,
                        new,
                ...
                #[inline(never)]
                pub unsafe fn relaxed_seqcst(dst: A, old: M, new: M) -> (M, bool) {
                    <T as crate::AtomicCompareExchange>::atomic_compare_exchange(
                        dst,
                        old,
                        new,
                ...
                #[inline(never)]
                pub unsafe fn acquire_relaxed(dst: A, old: M, new: M) -> (M, bool) {
                    <T as crate::AtomicCompareExchange>::atomic_compare_exchange(
                        dst,
                        old,
                        new,
                ...
                #[inline(never)]
                pub unsafe fn acquire_acquire(dst: A, old: M, new: M) -> (M, bool) {
                    <T as crate::AtomicCompareExchange>::atomic_compare_exchange(
                        dst,
                        old,
                        new,
                ...
                #[inline(never)]
                pub unsafe fn acquire_seqcst(dst: A, old: M, new: M) -> (M, bool) {
                    <T as crate::AtomicCompareExchange>::atomic_compare_exchange(
                        dst,
                        old,
                        new,
                ...
                #[inline(never)]
                pub unsafe fn release_relaxed(dst: A, old: M, new: M) -> (M, bool) {
                    <T as crate::AtomicCompareExchange>::atomic_compare_exchange(
                        dst,
                        old,
                        new,
                ...
                #[inline(never)]
                pub unsafe fn release_acquire(dst: A, old: M, new: M) -> (M, bool) {
                    <T as crate::AtomicCompareExchange>::atomic_compare_exchange(
                        dst,
                        old,
                        new,
                ...
                #[inline(never)]
                pub unsafe fn release_seqcst(dst: A, old: M, new: M) -> (M, bool) {
                    <T as crate::AtomicCompareExchange>::atomic_compare_exchange(
                        dst,
                        old,
                        new,
                ...
                #[inline(never)]
                pub unsafe fn acqrel_relaxed(dst: A, old: M, new: M) -> (M, bool) {
                    <T as crate::AtomicCompareExchange>::atomic_compare_exchange(
                        dst,
                        old,
                        new,
                ...
                #[inline(never)]
                pub unsafe fn acqrel_acquire(dst: A, old: M, new: M) -> (M, bool) {
                    <T as crate::AtomicCompareExchange>::atomic_compare_exchange(
                        dst,
                        old,
                        new,
                ...
                #[inline(never)]
                pub unsafe fn acqrel_seqcst(dst: A, old: M, new: M) -> (M, bool) {
                    <T as crate::AtomicCompareExchange>::atomic_compare_exchange(
                        dst,
                        old,
                        new,
                ...
                #[inline(never)]
                pub unsafe fn seqcst_relaxed(dst: A, old: M, new: M) -> (M, bool) {
                    <T as crate::AtomicCompareExchange>::atomic_compare_exchange(
                        dst,
                        old,
                        new,
                ...
                #[inline(never)]
                pub unsafe fn seqcst_acquire(dst: A, old: M, new: M) -> (M, bool) {
                    <T as crate::AtomicCompareExchange>::atomic_compare_exchange(
                        dst,
                        old,
                        new,
                ...
                #[inline(never)]
                pub unsafe fn seqcst_seqcst(dst: A, old: M, new: M) -> (M, bool) {
                    <T as crate::AtomicCompareExchange>::atomic_compare_exchange(
                        dst,
                        old,
                        new,
    ...
    macro_rules! t {
        ($t:ident) => {
            pub mod $t {
                ...
                #[inline(never)]
                pub unsafe fn relaxed_relaxed(dst: A, old: M, new: M) -> (M, bool) {
                    <T as crate::AtomicCompareExchange>::atomic_compare_exchange_weak(
                        dst,
                        old,
                        new,
                        Ordering::Relaxed,
    ...
    macro_rules! t {
        ($t:ident) => {
            pub mod $t {
                ...
                type A = *mut T;
                #[inline(never)]
                pub unsafe fn relaxed_relaxed(a: A, old: T, new: T) -> (T, bool) {
                ...
                #[inline(never)]
                pub unsafe fn relaxed_acquire(a: A, old: T, new: T) -> (T, bool) {
                    core::intrinsics::atomic_cxchg::<
                        _,
                        { AtomicOrdering::Relaxed },
                        { AtomicOrdering::Acquire },
                ...
                #[inline(never)]
                pub unsafe fn relaxed_seqcst(a: A, old: T, new: T) -> (T, bool) {
                    core::intrinsics::atomic_cxchg::<
                        _,
                        { AtomicOrdering::Relaxed },
                        { AtomicOrdering::SeqCst },
                ...
                #[inline(never)]
                pub unsafe fn acquire_relaxed(a: A, old: T, new: T) -> (T, bool) {
                    core::intrinsics::atomic_cxchg::<
                        _,
                        { AtomicOrdering::Acquire },
                        { AtomicOrdering::Relaxed },
                ...
                #[inline(never)]
                pub unsafe fn acquire_acquire(a: A, old: T, new: T) -> (T, bool) {
                    core::intrinsics::atomic_cxchg::<
                        _,
                        { AtomicOrdering::Acquire },
                        { AtomicOrdering::Acquire },
                ...
                #[inline(never)]
                pub unsafe fn acquire_seqcst(a: A, old: T, new: T) -> (T, bool) {
                    core::intrinsics::atomic_cxchg::<
                        _,
                        { AtomicOrdering::Acquire },
                        { AtomicOrdering::SeqCst },
                ...
                #[inline(never)]
                pub unsafe fn release_relaxed(a: A, old: T, new: T) -> (T, bool) {
                    core::intrinsics::atomic_cxchg::<
                        _,
                        { AtomicOrdering::Release },
                        { AtomicOrdering::Relaxed },
                ...
                #[inline(never)]
                pub unsafe fn release_acquire(a: A, old: T, new: T) -> (T, bool) {
                    core::intrinsics::atomic_cxchg::<
                        _,
                        { AtomicOrdering::Release },
                        { AtomicOrdering::Acquire },
                ...
                #[inline(never)]
                pub unsafe fn release_seqcst(a: A, old: T, new: T) -> (T, bool) {
                    core::intrinsics::atomic_cxchg::<
                        _,
                        { AtomicOrdering::Release },
                        { AtomicOrdering::SeqCst },
                ...
                #[inline(never)]
                pub unsafe fn acqrel_relaxed(a: A, old: T, new: T) -> (T, bool) {
                    core::intrinsics::atomic_cxchg::<
                        _,
                        { AtomicOrdering::AcqRel },
                        { AtomicOrdering::Relaxed },
                ...
                #[inline(never)]
                pub unsafe fn acqrel_acquire(a: A, old: T, new: T) -> (T, bool) {
                    core::intrinsics::atomic_cxchg::<
                        _,
                        { AtomicOrdering::AcqRel },
                        { AtomicOrdering::Acquire },
                ...
                #[inline(never)]
                pub unsafe fn acqrel_seqcst(a: A, old: T, new: T) -> (T, bool) {
                    core::intrinsics::atomic_cxchg::<
                        _,
                        { AtomicOrdering::AcqRel },
                        { AtomicOrdering::SeqCst },
                ...
                #[inline(never)]
                pub unsafe fn seqcst_relaxed(a: A, old: T, new: T) -> (T, bool) {
                    core::intrinsics::atomic_cxchg::<
                        _,
                        { AtomicOrdering::SeqCst },
                        { AtomicOrdering::Relaxed },
                ...
                #[inline(never)]
                pub unsafe fn seqcst_acquire(a: A, old: T, new: T) -> (T, bool) {
                    core::intrinsics::atomic_cxchg::<
                        _,
                        { AtomicOrdering::SeqCst },
                        { AtomicOrdering::Acquire },
                ...
                #[inline(never)]
                pub unsafe fn seqcst_seqcst(a: A, old: T, new: T) -> (T, bool) {
                    core::intrinsics::atomic_cxchg::<
                        _,
                        { AtomicOrdering::SeqCst },
                        { AtomicOrdering::SeqCst },
