            ...
            unsafe fn atomic_swap(
                ...
                unsafe {
                    ...
                    asm!(
                        ...
                        // - https://github.com/llvm/llvm-project/blob/llvmorg-15.0.0-rc1/llvm/test/CodeGen/SystemZ/atomicrmw-xchg-01.ll
                        "lb %r0, 0(%r3)",
                        "risbg %r1, %r2, 0, 189, 0",
                        "l %r3, 0(%r1)",
                        "sll %r2, 3",
            ...
            unsafe fn atomic_swap(
                ...
                unsafe {
                    ...
                    asm!(
                        ...
                        // Refs:
                        // - https://github.com/llvm/llvm-project/blob/llvmorg-15.0.0-rc1/llvm/lib/CodeGen/AtomicExpandPass.cpp#L682
                        // - https://github.com/llvm/llvm-project/blob/llvmorg-15.0.0-rc1/llvm/test/CodeGen/SystemZ/atomicrmw-xchg-02.ll
                        "lh %r0, 0(%r3)",
                        "risbg %r1, %r2, 0, 189, 0",
                        "l %r3, 0(%r1)",
                        "sll %r2, 3",
