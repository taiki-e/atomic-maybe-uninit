...
#[cfg(not(any(
    target_arch = "x86",
    target_arch = "x86_64",
    all(target_arch = "arm", any(target_feature = "v7", atomic_maybe_uninit_target_feature_v7)),
    target_arch = "aarch64",
    target_arch = "riscv32",
    target_arch = "riscv64"
)))]
...
mod aarch64;
#[cfg(all(target_arch = "arm", any(target_feature = "v7", atomic_maybe_uninit_target_feature_v7)))]
#[cfg(not(any(target_feature = "v8", atomic_maybe_uninit_target_feature_v8)))]
mod armv7;
#[cfg(all(target_arch = "arm", any(target_feature = "v8", atomic_maybe_uninit_target_feature_v8)))]
