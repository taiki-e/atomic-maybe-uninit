...
//
// Generated asm:
// - loongarch64 https://godbolt.org/z/1P6r17h3d
...
macro_rules! atomic_sub_word {
    ($int_type:ident, $asm_suffix:tt, $create_mask:tt) => {
        atomic_load!($int_type, $asm_suffix);
        impl AtomicStore for $int_type {
            #[inline]
            unsafe fn atomic_store(
                    ...
                    macro_rules! atomic_swap {
                        ($fence:tt) => {
                            asm!(
                                ...
                                "sll.w $a4, $a4, $a0",
                                "addi.w $a4, $a4, 0",
                                concat!("ld.", $asm_suffix, "u $a1, $a1, 0"),
                                "sll.w $a1, $a1, $a0",
                                "addi.w $a1, $a1, 0",
                                "2:",
                                    $fence,
            ...
            unsafe fn atomic_compare_exchange(
                ...
                unsafe {
                    ...
                    asm!(
                        ...
                        "and $a5, $a0, $a5",
                        "slli.d $a0, $a0, 3",
                        concat!("ld.", $asm_suffix, "u $a2, $a2, 0"),
                        "sll.w $a2, $a2, $a0",
                        "addi.w $a2, $a2, 0",
                        concat!("ld.", $asm_suffix, "u $a1, $a1, 0"),
                        "sll.w $a1, $a1, $a0",
...
atomic_sub_word!(i8, "b", "ori $a4, $zero, 255");
atomic_sub_word!(u8, "b", "ori $a4, $zero, 255");
atomic_sub_word!(i16, "h", "lu12i.w $a4, 15\nori $a4, $a4, 4095");
atomic_sub_word!(u16, "h", "lu12i.w $a4, 15\nori $a4, $a4, 4095");
atomic!(i32, "w");
atomic!(u32, "w");
#[cfg(target_arch = "loongarch64")]
atomic!(i64, "d");
